...
#define	SD_ONOFF_PIN					GPIO_Pin_3
#define	SD_ONOFF_PORT					GPIOD
#define	SD_ONOFF_CLOCK					RCC_AHB1Periph_GPIOD

#define	TarjetaSD_OFF					GPIO_SetBits(SD_ONOFF_PORT, SD_ONOFF_PIN);
#define	TarjetaSD_ON					GPIO_ResetBits(SD_ONOFF_PORT, SD_ONOFF_PIN);
...
/** 
  ...
  */
#define SDIO_TRANSFER_CLK_DIV           ((uint8_t)0x15) // (uint8_t)0x0d)//((uint8_t)0x1) cambiado -#-
